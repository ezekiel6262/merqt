...
const STEP_LABELS = ['Basics', 'Location', 'Details', 'Review']
      ...
      <div className="w-full max-w-lg">
        ...
        {step === 0 && (
          <Card className="p-5 space-y-4">
            ...
            <Button variant="primary" size="lg" className="w-full" disabled={!basicsValid} onClick={() => setStep(1)}>
              Continue
            </Button>
          </Card>
        )}
        ...
        {step === 3 && (
          <Card className="p-5">
            <div className="text-[15px] font-semibold mb-4">Review your profile</div>
            <div className="flex items-center gap-3 mb-4">
              {logoUrl ? (
                // eslint-disable-next-line @next/next/no-img-element
                <img src={logoUrl} alt="" className="w-12 h-12 rounded object-cover flex-shrink-0" />
              ) : (
              ...
              <div>
                ...
                <p className="text-xs text-merqt-text-muted">{category} · {city}</p>
              </div>
            </div>

            <div className="flex flex-col gap-2 text-[13.5px] mb-5">
              <div className="flex justify-between">
                <span className="text-merqt-text-muted">Address</span>
                <span className="max-w-[260px] text-right">
                  {noPhysicalOffice ? 'No physical office' : address || 'Not provided'}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-merqt-text-muted">Phone</span>
                <span>{phone || 'Not provided'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-merqt-text-muted">WhatsApp</span>
                <span>{whatsapp || 'Not provided'}</span>
              </div>
              {bio && (
                <div className="border-t border-merqt-border pt-2">
                  <span className="text-merqt-text-muted">Bio</span>
            ...
            <div className="flex gap-2.5">
              ...
              <Button variant="primary" size="lg" className="flex-1" disabled={loading} onClick={handleSubmit}>
